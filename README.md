...
calibration, AUC, Brier score �?with ratio and difference vs reference.
...
**Intersectional**: `intersectional_fairness()` for race × sex × age
...
- Hardt et al. (2016) *NeurIPS* �?Equality of Opportunity
